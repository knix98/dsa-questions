...
IMPORTANT : in the end in the base case wwe are not worried about checking whether the generated check string is unique or not
...
and hence its not possible that the recusrion would put the same brackets again at the same place
*/
class Solution {
private:
   vector<string> ans;
